...
urlpatterns = [
    ...
    path('password-reset-message/', auth_views.PasswordResetDoneView.as_view(template_name="authentication/password-reset-message.html"), name="password_reset_done"),
